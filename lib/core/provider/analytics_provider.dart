...
final liveAnalyticsStreamProvider = StreamProvider.family<List<AppAnalytics>, String>((ref, appId) {
...
final liveKpiProvider = FutureProvider.family<double, String>((ref, appId) async {
  final supabase = Supabase.instance.client;
