...
class LegalMentionsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SeoWrapper(
      title: 'Mentions Légales | Emryck Doré',
      description:
          'Consultez les mentions légales et la politique de confidentialité du portfolio de Emryck Doré.',
      url: 'https://godzyken.github.io/portefolio/legal',
      child: Scaffold(
        appBar: AppBar(
